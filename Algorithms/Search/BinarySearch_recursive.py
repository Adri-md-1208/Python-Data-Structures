...
def binarySearch_recursive(array, index0, indexN, value):
    """
    ...
    if index0 <= indexN:
        ...
        if array[mid] == value:
            ...
            return binarySearch_recursive(array, mid+1, indexN, value)

        elif array[mid] > value:
            return binarySearch_recursive(array, 0, mid-1, value)
